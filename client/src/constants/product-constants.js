/**
 * Product Constants & Validation
 * Centralized configuration for product categories, subcategories,
 * and form validation rules used across the Product Management module.
 */
